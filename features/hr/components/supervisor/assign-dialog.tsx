                            ...
                            <SelectItem key={sup.id} value={sup.id}>
                              <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-muted-foreground">
                                  {sup.nip} · {sup.currentCount}/
                                  {sup.maxInterns} intern
                                  {isFull ? " (Penuh)" : ""}
                                </span>
                              </div>
                            </SelectItem>
                      ...
                      >
                        <div className="flex-1 space-y-1.5">
                          ...
                          <Controller
                            ...
                            render={({
                              field: internField,
                              fieldState: internFieldState,
                            }) => (
                              <>
                                <Select
                                  value={internField.value}
                                  onValueChange={(val) =>
                                    internField.onChange(val ?? "")
                                  }
                                >
                                  <SelectTrigger
                                    className="w-full border-0 bg-muted px-4 py-2.5 data-placeholder:text-muted-foreground"
                                ...
                                {internFieldState.error && (
                                  <p className="text-xs text-destructive">
                                    {internFieldState.error.message}
                                  </p>
                                )}
                              </>
                            )}
